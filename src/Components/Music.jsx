...
// // const BASE_URL = `https://api.musixmatch.com/ws/1.1/chart.tracks.get?chart_name=top&page=1&page_size=5&country=us&f_has_lyrics=1&apikey=7fc8c50d3fbdc06210f5cbf637b5e143`;
...
// //         <div key={i}>
// //           <h1>{song.title}</h1>
// //           <img src={song.contributors[0].picture_small} alt="eman" />
// //           <br />
...
//     Axios.get(
//       `https://api.soundcloud.com/tracks?client_id=${this.client_id}&q=${value}`
//     )
...
//     Axios.get(
//       `https://api.soundcloud.com/playlists/209262931?client_id=${this.client_id}`
//     )
//       .then(function (response) {
